...
import com.company.sampleapp.SampleAppApplication
...
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = ["com.company.sampleapp.screen"])
@ContextConfiguration(classes = [SampleAppApplication::class, UiTestAssistConfiguration::class])
